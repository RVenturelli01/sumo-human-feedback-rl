...
WANDB_PROJECT="${WANDB_PROJECT:-local-experiments-thesis}"
...
AGENT_GRADIENT_STEPS="${AGENT_GRADIENT_STEPS:-32}"
...
REWARD_LR="${REWARD_LR:-0.002164752957354522}"
REWARD_GRADIENT_STEPS="${REWARD_GRADIENT_STEPS:-126}"
...
REWARD_L2="${REWARD_L2:-3.2079710683934115e-05}"
PREF_TEMPERATURE="${PREF_TEMPERATURE:-10.0}"
PREFERENCE_FRAGMENT_LENGTH="${PREFERENCE_FRAGMENT_LENGTH:-1}"
FRAGMENTER_TYPE="${FRAGMENTER_TYPE:-random}"
...
INITIAL_QUERIES="${INITIAL_QUERIES:-5000}"
QUERY_SCHEDULE="${QUERY_SCHEDULE:-hyperbolic}"
...
SCATTER_INTERVAL="${SCATTER_INTERVAL:-0}"
