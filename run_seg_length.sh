#!/bin/bash
# Esperimento: lunghezze di segmento (1 2 5 10 20 1000) × 5 seed
# comps_per_iter = seg*100, cappato a 20 per seg=1000
# WandB group = seg={seg}_comps={comps}  (esclude seed)
set -euo pipefail

PYTHON="python"
SCRIPT="test_seg_length.py"
LOG_DIR="/storage/fis3/logs_seg_length"
mkdir -p "$LOG_DIR"
...
# comps_per_iter per segmento (deve corrispondere a COMPS_FOR_SEG in test_seg_length.py)
