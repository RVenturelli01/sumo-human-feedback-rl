...
if __name__ == "__main__":
    ...
    cfg = OmegaConf.create({
        ...
        "algo":   {"kwargs": {
            ...
            "decay_rew": 0.0, "fragment_length": args.seg, "transition_oversampling": 1,
            "initial_comparisons": initial_comparisons, "initial_epoch_multiplier": 1,
            "query_schedule": "constant", "comparison_queue_size": 50_000,
            "n_ensembles_rew": 3, "train_comparison_frac": 0.8, "net_arch_rew": [128, 128],
        }},
        "train":  {"kwargs": {
